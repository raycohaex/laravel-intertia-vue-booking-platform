            ...
            <nav class="border-b border-gray-100">
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="shrink-0 flex items-center">
                                <Link :href="route('accommodation.index')">
                            ...
                            <div class="ml-3 relative" v-if="$page.props.user">
                                <Dropdown align="right" width="48">
                                    ...
                                    <template #content>
                                        ...
                                        <DropdownLink :href="route('bookings')">
                                            Bookings
                                        </DropdownLink>
                ...
                <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}" class="sm:hidden">
                    <div class="pt-2 pb-3 space-y-1">
                        <ResponsiveNavLink :href="route('accommodation.index')" :active="route().current('accommodation.index')">
                            Home
                        </ResponsiveNavLink>
                    </div>
